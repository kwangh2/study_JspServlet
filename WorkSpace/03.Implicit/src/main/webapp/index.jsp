					...
					<div class="col-xxl-5">
						...
						<div class="text-center text-xxl-start">
							<div
								...
								<div class="text-uppercase">JSP &middot; SERVLET
									&middot; JDBC</div>
							</div>
							<div class="fs-3 fw-light text-muted">취업도 해야하지만 </div>
							<h1 class="display-3 fw-bolder mb-5">
								<span class="text-gradient d-inline">집에 가고싶다!</span>
							</h1>
							<div
					...
					<div class="card shadow border-0 rounded-4 mb-4">
						<div class="card-body p-3">
							<div class="row align-items-center gx-5">
								...
								<div class="col-lg-8">
									<div>
										<a href="ex01_req">Controller에 요청 (Servlet)</a><br> 
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card shadow border-0 rounded-4 mb-4">
						<div class="card-body p-3">
							<div class="row align-items-center gx-5">
								...
								<div class="col-lg-8">
									<div>
										<a href="list">목록 조회 화면(usertbl)</a><br> 
									</div>
								</div>
							</div>
						</div>
