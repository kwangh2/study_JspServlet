					...
					<div class="col-xxl-7">
						...
						<div class="d-flex justify-content-center mt-5 mt-xxl-0">
							<div class="profile bg-gradient-primary-to-secondary">
								...
								<img class="profile-img" src="assets/snoopy1.png" alt="..." />
								<div class="dots-1">
									<!-- SVG Dots-->
							...
							<div class="row align-items-center gx-5">
								<div class="col text-center text-lg-start mb-4 mb-lg-0">
									<div class="bg-light p-4 rounded-4">
										<div class="text-primary fw-bolder mb-2">태그 처음 사용</div>

									</div>
								</div>
								<div class="col-lg-8">
									<div>
										<a href="01.script\ex00Into.jsp">태그와 변수 이용</a><br> <a
											href="01.script\ex01Var.jsp">여러 변수 선언, 할당, 출력 </a>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="card shadow border-0 rounded-4 mb-4">
				<div class="card-body p-3">
					<div class="row align-items-center gx-5">
						<div class="col text-center text-lg-start mb-4 mb-lg-0">
							<div class="bg-light p-4 rounded-4">
								<div class="text-primary fw-bolder mb-2">제어문</div>

							</div>
						</div>
						<div class="col-lg-8">
							<div>
								<a href="01.script\ex02For.jsp">for문 </a><br> <a
									href="01.script\ex02If.jsp">if문 </a><br> <a
									href="01.script\ex03TestForIf.jsp">TestForIf </a>
			...
			<div class="card shadow border-0 rounded-4 mb-4">
				<div class="card-body p-3">
					<div class="row align-items-center gx-5">
						<div class="col text-center text-lg-start mb-4 mb-lg-0">
							<div class="bg-light p-4 rounded-4">
								<div class="text-primary fw-bolder mb-2">3. 연습</div>
						...
						<div class="col-lg-8">
							<div>
								...
								<a href="01.script\ex03TestForIf.jsp">합구하기 </a> <br> <a
									href="01.script\ex04ForFor.jsp">구구단 </a><br> <a
									href="01.script\EtcMethod.jsp">3. 메소드 </a> <br>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card shadow border-0 rounded-4 mb-5">
					<div class="card-body p-5">
						<div class="row align-items-center gx-5">
							<div class="col text-center text-lg-start mb-4 mb-lg-0">
								<div class="bg-light p-4 rounded-4">
									<div class="text-secondary fw-bolder mb-2">Directive Tag
										Page</div>
								</div>
							</div>
							<div class="col-lg-8">
								<a href="02.Directive\Ex01_Directive.jsp">1. 디렉티브 기본 </a> <br>
								<a href="02.Directive\Ex02_ErrorMain.jsp">2. 에러페이지 </a> <br>
							</div>
				...
				<div class="card shadow border-0 rounded-4 mb-5">
					<div class="card-body p-5">
						<div class="row align-items-center gx-5">
							<div class="col text-center text-lg-start mb-4 mb-lg-0">
								<div class="bg-light p-4 rounded-4">
									<div class="text-secondary fw-bolder mb-2">Directive
										include</div>
								</div>
							</div>
							<div class="col-lg-8">
								<a href="02.Directive\Ex03_Main.jsp">1. 붙이기 Header Footer</a> <br>
								<a href="02.Directive\Ex04_Main.jsp">1. 붙이기 Header Footer</a> <br>
			...
			<div class="card shadow border-0 rounded-4 mb-5">
				<div class="card-body p-5">
					<div class="row align-items-center gx-5">
						...
						<div class="col-lg-8">
							<a href="03.Action/Ex01_Forward.jsp">1. 포워드  </a> <br>
						</div>
			...
			<div class="card shadow border-0 rounded-4 mb-5">
				<div class="card-body p-5">
					<div class="row align-items-center gx-5">
						...
						<div class="col-lg-8">
							<a href="03.Action/Ex02_Include.jsp">1. 인클루드  </a> <br>
						</div>
			...
			<div class="card shadow border-0 rounded-4 mb-5">
				<div class="card-body p-5">
					<div class="row align-items-center gx-5">
						<div class="col text-center text-lg-start mb-4 mb-lg-0">
							<div class="bg-light p-4 rounded-4">
								<div class="text-success fw-bolder mb-2">Bean 객체(JSP)  </div>
							</div>
						</div>
						<div class="col-lg-8">
							Jsp(Spring) Bean 객체가 핵심이 되는 내용이지만 현재는 JSP 코드로 사용하는것은 매우 불편함.
			...
			<div class="row gx-5 justify-content-center">
				<div class="col-xxl-8">
					<div class="text-center my-5">
						...
						<p class="lead fw-light mb-4">My name is Start Bootstrap and I
							help brands grow.</p>
